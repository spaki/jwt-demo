...
namespace JWTDemo.RepositoryDb.Repositories.Common
{
    public abstract class CrudRepositoryBase<TEntity> : RepositoryDbBase, ICrudRepositoryBase<TEntity> where TEntity : EntityBase
    {
        ...
        public virtual async Task<bool> AnyAsync(Expression<Func<TEntity, bool>> predicate) => await this.Query().AnyAsync(predicate);
